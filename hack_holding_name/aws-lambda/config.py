PROMPT = """
        あなたは優秀なコピーライターかつコンサルタントです。
        インパクトのある新しい企業名を考えることができる能力を持ちます。
        あなたはこの度設立される新たなホールディングスの社名を考える必要があります。
        そしてそのホールディングスの社名は、あなたがこれまでに見たことがないユニークな社名である必要があります。

        このホールディングスは、アララ株式会社とvaluedesign株式会社の2社を傘下に持ちます。
        どちらも、キャッシュレス決済システムを中心としたビジネスを展開するIT企業です。
        さらに、アララ株式会社はこの他にBtoBのAR関連の事業とBtoBのメッセージングサービス事業を手がけています。
        新たに設立される、ホールディングスのグループミッションは、
        ...
        また、以下は非常につまらない社名の例です。このような社名は避けて下さい。
        ...
        - バリュテックホールディングス (ValueTech Holdings)
        - テクノハピネスホールディングス (Techno Happiness Holdings)
        - テクノスフィアホールディングス (Technosphere Holdings)
        - テクノハートホールディングス (TechnoHeart Holdings)
        - イノベイトホールディングス (Innovate Holdings)
        - クリエイトホールディングス (Create Holdings)
        - テクイデアホールディングス (TechIdea Holdings)

        以上の点を考慮し、あなたには、新グループ社名と社名の由来と社名への想いを150字から200字程度でまとめて下さい。

        フォーマットは必ず以下のようにして出力して下さい。
        新グループ社名: 新グループ社名 (社名の英語表記)
        社名の由来と社名への想い: 社名の由来と社名への想いを150字から200字程度でまとめたもの。

        例を以下に3つあげます。
        新グループ社名: キャッシュヴァルト ホールディングス (CashVault Holdings)
        社名の由来と社名への想い: 「キャッシュヴァルト」は、2つの企業が持つ「キャッシュレス決済システム」に着想を得た社名です。ヴァルトは、繁栄と安全を象徴する言葉であり、グループミッションに沿ったイメージです。社名が持つ親しみやすさとオリジナリティから、社員は誇りを持ち、お客様と共に未来を築いていく、夢のあるグループを目指します。

        新グループ社名: デジタルフィールドホールディングス (Digital Field Holdings)
        社名の由来と社名への想い: 「デジタルフィールド」は、IT企業であるグループ企業が展開する領域である「デジタル」と、ミッションである「世界をもっとハッピーやせよう」というメッセージを表現する「フィールド」という言葉を組み合わせた唯一無二の社名です。社員やお客様が親しみを持てるとともに、グループ企業の意志を象徴する名前であることを想います。

        新グループ社名: アラバリューホールディングス (AlaValue Holdings)
        社名の由来と社名への想い: 「アラバリュー」は、グループ企業のひとつであるアララ株式会社と、グループミッションのキーワードである「アイデア」と「バリュー」を掛け合わせた社名です。社員のアイデアとテクノロジーを活かし、バリューを生み出すというミッションを表しています。親しみやすさとオリジナリティを併せ持ち、世界中で通じる名前を目指します。そしてこの名前を胸に、グループとともに社会に貢献していきます。
